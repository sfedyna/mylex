 ...
 */
class Voucher extends \App\Entities\Voucher implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'App\\Entities\\Voucher' . "\0" . 'duration', '' . "\0" . 'App\\Entities\\Voucher' . "\0" . 'percentOff', '' . "\0" . 'App\\Entities\\Voucher' . "\0" . 'currency', '' . "\0" . 'App\\Entities\\Voucher' . "\0" . 'campaign'];
        }
