...
class User extends \App\Entities\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'App\\Entities\\User' . "\0" . 'email', '' . "\0" . 'App\\Entities\\User' . "\0" . 'name', '' . "\0" . 'App\\Entities\\User' . "\0" . 'roles', '' . "\0" . 'App\\Entities\\User' . "\0" . 'created', '' . "\0" . 'App\\Entities\\User' . "\0" . 'updated', 'password', 'rememberToken'];
        }
     ...
     * {@inheritDoc}
     */
    public function setRoles($roles = 'ROLE_CLIENT')
    {
